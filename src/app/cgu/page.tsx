    ...
    <main className="min-h-screen bg-canvas text-action">
      ...
      <article className="mx-auto max-w-4xl px-6 py-16 md:px-10">
        <div className="prose prose-sm max-w-none text-action">
          ...
          <h2 className="mt-8 text-2xl font-bold text-brand">1. Objet</h2>
          ...
          <h2 className="mt-8 text-2xl font-bold text-brand">2. Acceptation des CGU</h2>
          <p>
          ...
          <h2 className="mt-8 text-2xl font-bold text-brand">3. Création et utilisation d'un compte</h2>
          <p>
          ...
          <h2 className="mt-8 text-2xl font-bold text-brand">4. Utilisation des profils</h2>
          <p>
          ...
          <h2 className="mt-8 text-2xl font-bold text-brand">5. Certification</h2>
          <p>
          ...
          <h2 className="mt-8 text-2xl font-bold text-brand">6. Contenus publiés par les utilisateurs</h2>
          <p>
          ...
          <h2 className="mt-8 text-2xl font-bold text-brand">7. Vidéos et services tiers</h2>
          <p>
          ...
          <h2 className="mt-8 text-2xl font-bold text-brand">8. Données personnelles</h2>
          <p>
          ...
          <h2 className="mt-8 text-2xl font-bold text-brand">9. Sécurité</h2>
          ...
          <h2 className="mt-8 text-2xl font-bold text-brand">10. Disponibilité du service</h2>
          ...
          <h2 className="mt-8 text-2xl font-bold text-brand">11. Suspension ou suppression d'un accès</h2>
          <p>
          ...
          <h2 className="mt-8 text-2xl font-bold text-brand">12. Évolution des CGU</h2>
          <p>
          ...
          <h2 className="mt-8 text-2xl font-bold text-brand">13. Version et traçabilité</h2>
          <div className="rounded-lg bg-surface-soft p-4 font-mono text-sm">
          ...
          <p className="mt-4">
            La version <code className="rounded bg-surface-soft px-2 py-1">1.0</code> ne doit pas être
            considérée comme publiée tant que la validation juridique n'a pas été obtenue.
          </p>

          <h2 className="mt-8 text-2xl font-bold text-brand">14. Validation juridique</h2>
          <p>
          ...
          <div className="mt-12 flex gap-4">
            <Button
              asChild
              className="rounded-2xl bg-brand text-white hover:bg-brand-700"
            >
